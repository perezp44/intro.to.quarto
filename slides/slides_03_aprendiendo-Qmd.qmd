...
- Veremos más opciones de YAML cuando vemos la creación de páginas web
...
- Fue creado por [John Grueber](https://daringfireball.net/projects/markdown/) y [Aaron Swartz](https://es.wikipedia.org/wiki/Aaron_Swartz) en 2004
...
+-----------------------------------+------------------------------+
| Markdown (si escribes esto)       | Se verá esto:                |
+===================================+==============================+
...
+-----------------------------------+------------------------------+
|     [En versalita]{.underline}    | [En versalita]{.smallcaps}   |
+-----------------------------------+------------------------------+
