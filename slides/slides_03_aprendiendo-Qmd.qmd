...
-   Se utiliza para fijar metadatos (opciones) sobre el documento

-   Iremos viendo más opciones a lo largo del curso
...
-   Con `.qmd` **podemos incorporar código**
...
-   Cuando Quarto/`knitr` procesen el chunk, se interpretará como código R y **ejecutará las instrucciones y mostrará en el documento final el output** generado por el chunk.
...
- Se hace de esta forma (dentro de "execute"):
...
### (IIc) "Chunks" inline (inline code)

<https://quarto.org/docs/computations/execution-options.html#inline-code> y 

------------------------------------------------------------------------

### (IId) "Chunks" **no ejecutables**
...
### (IIc) Chunks: diferencias entre Quarto y Rmd
