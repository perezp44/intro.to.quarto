...
- Por ejemplo: **tutoriales**, **transparencias**, **páginas web**,  **blogs**, ...
...
![](./imagenes/ss_01_info-r4ds_01.png){#fig-01 fig-align="center" width="85%"}
<br>
...
### ¿Qué tipo de documentos veremos?{.incremental}

- Principalmente **tutoriales**, **transparencias**, **páginas web** y **blogs**, 


- Con Quarto se pueden generar documentos de muchos tipos y formatos: artículos académicos, libros, tesis, cartas, cuadros de mando,  etc ... etc ...  Puedes visitar la [Quarto gallery](https://quarto.org/docs/gallery/){target="blank"} 

<br>

### Ejemplos

  - **Tutoriales**: por ejemplo [este](https://quarto-dev.github.io/quarto-gallery/page-layout/tufte.html){target="blank"} 

  - **Slides**: por ejemplo [estas](https://apreshill.github.io/palmerpenguins-useR-2022/#/title-slide){target="blank"} 
  
  - **Páginas web**: por ejemplo [esta](https://sta210-s22.github.io/website/){target="blank"} o [esta](https://www.stat.cmu.edu/~ryurko/){target="blank"} 

  - **Blogs**: por ejemplo [este](https://www.mm218.dev/){target="blank"} 
