...
## Ejemplos de webs (hechos con Quarto) {.smaller}
...
<iframe src="https://quarto.org/docs/guide/" title="https://quarto.org/docs/guide/" width="960" height="500" data-external="1"></iframe>
...
-   Veamos un ejemplo con el siguiente [post](/blog/25_css.html)
...
-   Tengo una "práctica" en el [tutorial nº6](https://perezp44.github.io/taller.primer.blog/taller/06_taller_tuneado-del-blog.html#sass){target="_blank"} del taller "Mi primer blog con Quarto".
