...
-   Un documento fuente puede generar documentos de varios tipos: tutoriales, slides, ... [\[Gallery\]](https://quarto.org/docs/gallery/)

-   Facilidad de generación de páginas web

-   Si incluyes código, se acaba el corta y pega para gráficos etc...
...
-   Son 3 programas de ordenador
    ...
    -   RStudio es un IDE (para usar Quarto y R de manera más cómoda)

    -   **Quarto** es un CLI (y es el que realmente hará los documentos)
...
-   Es un sistema para generar publicaciones científico-técnicas
...
-   Es simplemente una **carpeta** donde tendremos los "materiales" que necesitemos para crear uno de nuestros proyectos (tutorial, blog, slides etc...)

-   Usarlos tiene ventajas (usaremos rutas relativas y ...)
...
2.  ¿Cómo saber si realmente estás dentro de un proyecto?
    -   En la esquina superior-izquierda de de RStudio veras el icono azulito junto al nombre del proyecto
:::
