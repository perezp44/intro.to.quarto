...
- Si dentro de un párrafo necesitas que una frase empiece en otra linea entonces, **has de dejar 2 (o más) espacios al final**; en inglés esto se conoce como un "hard line break"
    ...
    - El "hard line break" se puede hacer con `<br>`

    - El "hard line break" también se puede hacer con \ seguido de nueva linea. 
    
    - En una celda de una tabla, esta es la única forma de crear un salto de línea, ya que se ignoran los espacios finales en las celdas.

. . . 

- Si en una linea de texto hay **2 espacios o más**, estos se reducen a un espacio.

- Por lo tanto, si quieres separar palabras con más de un espacio, tendrás que usar lo que en html se conoce como "entities": `&nbsp;`(1 espacio)  `&ensp;`(2 espacios)  y `&emsp;`(4 espacios). Otra forma sería con la etiqueta `<pre>`.

. . . 

<br>

- Para crear más espacio entre párrafos (una linea en blanco extra) podemos usar: `<br>`
...
- Para practicar a escribir con Markdown podemos hacerlo en RStudio o usar editores online como [este](https://dillinger.io/) o [este](https://vuejs.org/examples/#markdown)
