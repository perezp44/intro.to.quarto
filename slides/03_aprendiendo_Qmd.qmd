...
- `output: asis`: permite generar raw-markdown. Un ejemplo [aquí](https://quarto.org/docs/computations/execution-options.html#raw-output)
...
- Pandoc soportas syntax highlighting para cerca de [140 different languages](https://github.com/jgm/skylighting/tree/master/skylighting-core/xml). If your language is not supported then you can use the `default` language.
...
(**) Los emojis mejor desde el editor visual o copiándolo.
...
# (III) Más elementos {.unnumbered background-color="#ebf5fb"}
...
- Por ejemplo: links, imágenes, videos, ecuaciones, tablas, notas al pie, bibliografía, etc ....


## (III) Más elementos: hyper-**links**
...
|Si escribes esto:                                    | Al procesarse se verá esto:          |
+=====================================================+======================================+
|     ![](imagenes/img_01_h1.png)                     | ![](imagenes/img_01_h1.png)          |
+-----------------------------------------------------+--------------------------------------+
|     ![](./imagenes/img_01_h1.png)                   | ![](./imagenes/img_01_h1.png)        |
+-----------------------------------------------------+--------------------------------------+
+-----------------------------------------------------+--------------------------------------+
...
[![Caption](imagenes/img_01_h1.png)](https://quarto.org)    
     
[![Caption](imagenes/img_01_h1.png)](https://quarto.org "An elephant")
    
[![](imagenes/img_01_h1.png){fig-alt="Alt text"}](https://quarto.org)
    



## (III) Más elementos: Tablas <mark>con Markdown</mark>
...
- Markdown admite ecuaciones **escritas en Latex** si van entre **$** para ecuaciones inline y **$$** para ecuaciones independientes. [Aquí](http://www.sciweavers.org/free-online-latex-equation-editor) tienes un editor de ecuaciones en latex online, y [aquí](https://dereksonderegger.github.io/570L/16-rmarkdown-tricks.html) algunos ejemplos de ecuaciones escritas en Latex.
...
## (III) Más elementos: Notas al pie
