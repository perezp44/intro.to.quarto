...
Es un programa sin interfaz gráfica (sin menús ni ventanas). Se maneja a través la Términal con lineas de comandos, así que técnicamente es un programa de tipo CLI (command line interface), pero no sufras porque (casi siempre) interactuaremos con él a través de RStudio.
